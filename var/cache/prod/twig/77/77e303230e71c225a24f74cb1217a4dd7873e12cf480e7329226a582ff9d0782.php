...
class __TwigTemplate_508edab10728b33f63cc081f33c91a7d216d71ea33fbb212cbe73344c30a2eab extends Template
{
    ...
    <div class=\"col-sm-3 mt-4\">
        <div class=\"form-group\" style=\"width: 110%;\">
            ";
        // line 379
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "secteurActivite", [], "any", false, false, false, 379), 'label', ["label_attr" => ["class" => "foo"], "label" => "Secteur d'activité"]);
        echo "
            ";
        // line 380
...
//                    !\$(\"[id^=lazemTet5aba]:not(#lazemTet5abaTransportPerso)\").hide();
        ...
        <div class=\"form-group\" style=\"width: 110%;\">
            ...
            ";
        // line 1169
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "nbAssocies", [], "any", false, false, false, 1169), 'label', ["label_attr" => ["class" => "foo"], "label" => "Nombre d'associés"]);
        echo "
            ";
        // line 1170
