...
class __TwigTemplate_b30c8976a517ef384eb33e97b616925c0d7f0361ea4b075be94da30d498a14eb extends Template
{
    private $source;
    private $macros = [];
            ...
            <div class=\"col-12 col-md-8 col-lg-6 col-xl-5\">
                <div class=\"card shadow-2-strong\" style=\"border-radius: 1rem;\">
                    <div class=\"card-body  text-center\">
                        ...
                        <div class=\"form-outline \">
                            <form action=\"{{ path('registre') }}\" method=\"post\">
                            <input  type=\"email\" id=\"email\" name=\"email\"  class=\"form-control \"   placeholder=\"Adresse email a rentrer \">
                            <button  class=\"btn btn-primary\"  type=\"submit\">Commencer</button>
                            </form>
                        ...
                        {% endblock %}
", "home/index.html.twig", "C:\\Users\\21629\\Desktop\\VendrediAldini\\adlini\\templates\\home\\index.html.twig");
    }
}
