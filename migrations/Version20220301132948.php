 ...
 */
final class Version20220301132948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dossier ADD capital DOUBLE PRECISION DEFAULT NULL');
        $this->addSql('ALTER TABLE excercice DROP nom_excercice, CHANGE date_ouverture date_ouverture VARCHAR(255) NOT NULL, CHANGE date_cloture date_cloture VARCHAR(255) NOT NULL');
    }
