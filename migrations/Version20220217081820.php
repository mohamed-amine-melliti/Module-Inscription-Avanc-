 ...
 */
final class Version20220217081820 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE mode_paiement_choisi mode_paiement_choisi VARCHAR(255) DEFAULT NULL');
    }
