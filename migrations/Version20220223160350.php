 ...
 */
final class Version20220223160350 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE excercice (id INT AUTO_INCREMENT NOT NULL, date_ouverture DATE NOT NULL, date_cloture DATE NOT NULL, nom_excercice VARCHAR(255) NOT NULL, regime_tva VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
