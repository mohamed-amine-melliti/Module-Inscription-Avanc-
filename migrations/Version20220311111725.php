 ...
 */
final class Version20220311111725 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE dossier ADD nom_president VARCHAR(255) DEFAULT NULL, ADD prenom_president VARCHAR(255) DEFAULT NULL, ADD capital_president DOUBLE PRECISION DEFAULT NULL, ADD nom_entrepreneur VARCHAR(255) DEFAULT NULL, ADD prenom_entrepreneur VARCHAR(255) DEFAULT NULL, ADD capital_entrepreneur DOUBLE PRECISION DEFAULT NULL');
   }
