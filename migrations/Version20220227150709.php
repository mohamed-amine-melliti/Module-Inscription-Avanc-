 ...
 */
final class Version20220227150709 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
       ...
       // $this->addSql('ALTER TABLE excercice DROP nom_excercice');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE excercice ADD nom_excercice VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE regime_tva regime_tva VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
