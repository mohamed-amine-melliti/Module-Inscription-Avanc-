 ...
 */
final class Version20220315160538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dossier CHANGE capital_social capital_social VARCHAR(255) DEFAULT NULL');
    }
